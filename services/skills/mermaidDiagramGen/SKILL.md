...
## Dependencies
- Access to the local manuals directory: `c:\temp\AI Local\services\skills\Mermaid/` (contains files like `flowchart.md`, `sequenceDiagram.md`, `classDiagram.md`, `entityRelationshipDiagram.md`, etc.).
